...
if planeteer_calls.find("Wind") {|string| string == "Earth"||"Wind"}# Use an Enumerable to check if any elements in the passed in array match the valid calls listed above
